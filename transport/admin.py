...
from transport.models import Area,Client, Driver, Maintenance,Passenger, ServiceMan, Trip, TripCategory, TripPath, Vehicle, VehicleEvent, VehicleWorkEvent, WorkShift
