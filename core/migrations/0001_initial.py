    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_name', models.CharField(choices=[('projectmanager', 'projectmanager'), ('accounting', 'accounting'), ('web', 'web'), ('transport', 'transport'), ('log', 'log'), ('map', 'map'), ('market', 'market'), ('stock', 'stock'), ('authentication', 'authentication'), ('dashboard', 'dashboard'), ('polls', 'polls')], max_length=50, verbose_name='اپلیکیشن')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('link_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='core.link')),
                ('app_name', models.CharField(choices=[('projectmanager', 'projectmanager'), ('accounting', 'accounting'), ('web', 'web'), ('transport', 'transport'), ('log', 'log'), ('map', 'map'), ('market', 'market'), ('stock', 'stock'), ('authentication', 'authentication'), ('dashboard', 'dashboard'), ('polls', 'polls')], max_length=50, verbose_name='app_name')),
