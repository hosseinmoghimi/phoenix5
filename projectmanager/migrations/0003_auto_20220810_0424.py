...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('projectmanager', '0002_auto_20220808_1816'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='request',
            name='status',
            field=models.CharField(choices=[('پیش نویس', 'پیش نویس'), ('DEFAULT', 'DEFAULT'), ('تعریف اولیه در سیستم', 'تعریف اولیه در سیستم'), ('تحویل شده', 'تحویل شده'), ('در حال تست', 'در حال تست'), ('در حال انجام', 'در حال انجام'), ('رد شده', 'رد شده'), ('پذیرفته شده', 'پذیرفته شده'), ('درخواست شده', 'درخواست شده'), ('آماده برای خرید', 'آماده برای خرید'), ('در حال خرید', 'در حال خرید'), ('متعلق به کارفرما', 'متعلق به کارفرما'), ('موجود در انبار', 'موجود در انبار'), ('خارج شده از انبار', 'خارج شده از انبار'), ('وارد شده به انبار', 'وارد شده به انبار'), ('تحویل گرفته شده از کارفرما', 'تحویل گرفته شده از کارفرما'), ('پرداخت شده', 'پرداخت شده')], max_length=50, verbose_name='status'),
        ),
        migrations.AlterField(
