# Generated by Django 3.2.13 on 2022-08-26 22:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.option', verbose_name='option')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.student', verbose_name='student')),
            ],
            options={
                'verbose_name': 'SelectedOption',
                'verbose_name_plural': 'SelectedOptions',
            },
            bases=(models.Model, utility.utils.LinkHelper),
        ),
        migrations.AddField(
            model_name='option',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.question', verbose_name='question'),
        ),
        migrations.CreateModel(
            name='Course',
            fields=[
        ...
        migrations.AddField(
            model_name='question',
            name='exam',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.exam', verbose_name='exam'),
        ),
        migrations.CreateModel(
            name='Major',
            fields=[
