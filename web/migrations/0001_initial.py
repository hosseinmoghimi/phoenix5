# Generated by Django 3.2.13 on 2022-05-29 11:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('success', 'success'), ('danger', 'danger'), ('warning', 'warning'), ('primary', 'primary'), ('muted', 'muted'), ('secondary', 'secondary'), ('info', 'info'), ('light', 'light'), ('rose', 'rose'), ('dark', 'dark')], default='light', max_length=50, verbose_name='color')),
            ...
            options={
                'verbose_name': 'PricingItem',
                'verbose_name_plural': 'PricingItems',
            },
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'PricingPage',
                'verbose_name_plural': 'PricingPages',
            },
            bases=('core.page',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='PricingItemSpecification',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, verbose_name='نام')),
                ('value', models.CharField(max_length=200, verbose_name='مقدار')),
                ('priority', models.IntegerField(default=100, verbose_name='ترتیب')),
                ('pricing_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.pricingitem', verbose_name='آیتم')),
            ],
            options={
                'verbose_name': 'PricingItemSpecification',
                'verbose_name_plural': 'PricingItemsSpecification',
            },
            bases=(models.Model, utility.utils.LinkHelper),
        ),
        migrations.AddField(
            ...
            name='pricing_page',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.pricingpage', verbose_name='pricing page'),
        ),
        migrations.CreateModel(
            name='OurWork',
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='core.page')),
                ('for_home', models.BooleanField(default=False, verbose_name='for_home')),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='web.ourteam', verbose_name='author')),
            ],
            options={
